...
export default function Home() {
  return (
    ...
    <div className="" style={{
      backgroundImage: "linear-gradient(to bottom right, rgba(255, 255, 255, 0.5), rgba(0, 51, 53, 0.61))",
      ...
      <div id="tabs" className="flex flex-row ">
        ...
        <div className="center flex-1 flex justify-center items-center text-center">
          <h1 className="font-space-grotesk">About Me</h1>
        </div> 
      </div>
